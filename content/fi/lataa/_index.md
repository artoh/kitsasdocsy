...
<div style="justify-content:center; text-align:center; margin: 0px; width: 200% !important;">
  ...
  <div  id="pills-tabContent" class="tab-content">
    <div class="tab-pane fade" id="pills-win" role="tabpanel" aria-labelledby="pills-home-tab" style="text-align: center;">      
      ...
      <p>
        <a href="https://github.com/artoh/kitupiikki/releases/download/v4.0.1/kitsas-4.0.1-asennus.exe" class="btn btn-lg btn-primary latausnappi">
      ...
      <p>
        <a href="https://github.com/artoh/kitupiikki/releases/download/v4.0.1/kitsas-4.0.1.exe" class="btn btn-lg btn-primary">
          <span class="fa fa-download"></span>&nbsp;Lataa</a>
      </p>            
    ...
    <div class="tab-pane fade" id="pills-linux" role="tabpanel" aria-labelledby="pills-contact-tab" style="text-align: center;">
      ...
      <h4>Kitsas 4.0.1</h4>
      <p>
        <a href="https://github.com/artoh/kitupiikki/releases/download/v4.0.1/Kitsas-4.0.1-x86_64.AppImage" class="btn btn-lg btn-primary">
          <span class="fa fa-download"></span>&nbsp;Lataa</a>
      </p>           
