  ...
  <div  id="pills-tabContent" class="tab-content">
    <div class="tab-pane fade" id="pills-win" role="tabpanel" aria-labelledby="pills-home-tab" style="text-align: center;">    
      <div class="container">
        ...
        <h4>Windows 10, 11</h4>      
        <h4 class="variaatio" style="margin-top: 2ex;">Kitsas 5.11.1</h4>
        <p>
          <a href="https://github.com/artoh/kitupiikki/releases/download/v5.11.1/kitsas-5.11.1-asennus.exe" class="btn btn-lg btn-primary latausnappi">
    ...
    <div class="tab-pane fade" id="pills-mac" role="tabpanel" aria-labelledby="pills-profile-tab" style="text-align: center;">      
      <div class="container">        
        ...
        <h4 class="variaatio" style="margin-top: 2ex;">Kitsas 5.11.1</h4>
        <p>
          <a href="https://github.com/petriaarnio/kitupiikki/releases/download/mac-v5.11.1/Kitsas-5.11.1.dmg" class="btn btn-lg btn-primary latausnappi">
            <span class="fa fa-download"></span>&nbsp;Lataa</a>
        </p>                  
    ...
    <div class="tab-pane fade" id="pills-linux" role="tabpanel" aria-labelledby="pills-contact-tab" style="text-align: center;">
      <div class="container">     
        ...
        <h4 class="variaatio" style="margin-top: 2ex;">Kitsas 5.11.1</h4>
        <p>
          <a href="https://github.com/artoh/kitupiikki/releases/download/v5.11.1/Kitsas-5.11.1-x86_64.AppImage">
            <span class="fa fa-download"></span>&nbsp;Lataa</a>
        </p>           
        ...
        <ol style="text-align: left;">
          ...
          <li>Käynnistä ohjelma klikkaamalla tiedostoa tai komennolla <code>./Kitsas-5.11.1-x86_64.AppImage</code></li>
          <li>Jos ohjelma kaatuu NSS-tietokannan alustamisen virheeseen, käynnistä komennolla <code>LD_LIBRARY_PATH="/usr/lib/x86_64-linux-gnu/nss" ./Kitsas-5.11.1-x86_64.AppImage</code><br/> tai käytä valitsinta <code>--noweb</code>.          
</li>          
        </ol>    
      </div>      
    </div>
