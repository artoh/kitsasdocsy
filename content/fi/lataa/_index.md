  ...
  <div  id="pills-tabContent" class="tab-content">
    <div class="tab-pane fade" id="pills-win" role="tabpanel" aria-labelledby="pills-home-tab" style="text-align: center;">    
      <div class="container">
        ...
        <p>
          <a href="https://github.com/artoh/kitupiikki/releases/download/v5.1/kitsas-5.1-asennus.exe" class="btn btn-lg btn-primary latausnappi">
    ...
    <div class="tab-pane fade" id="pills-mac" role="tabpanel" aria-labelledby="pills-profile-tab" style="text-align: center;">      
      <div class="container">
        ...
        <h4 class="variaatio" style="margin-top: 2ex;">Kitsas 5.1</h4>
        <p>
          <a href="https://github.com/petriaarnio/kitupiikki/releases/download/mac-v5.1/Kitsas-5.1.dmg" class="btn btn-lg btn-primary latausnappi">
            <span class="fa fa-download"></span>&nbsp;Lataa</a>
        </p>          
