...
Tilioteaineiston vastaanottamiseen riittää **pankin ja asiakkaan välinen valtakirja**. Pyydäthän Kitsaan helpdeskilta lisäosan aktivoinnin, eli aineiston vastaanottokanavan avausta

**Maksujen vahvistamisen valtakirja** tulee toimittaa Kitsaan helpdeskille, mikäli Kitsaasta halutaan muodostaa maksuja

Alla ohjeet valtakirjojen täyttöön:
-	[Maksujen vahvistamisen valtakirja]( https://kitsas.fi/docs/lisaosat/maksuliikenne/valtakirjat/#maksujen-vahvistamisen-valtakirja)
-	[Osuuspankki]( https://kitsas.fi/docs/lisaosat/maksuliikenne/valtakirjat/#osuuspankki)
-	[Nordea]( https://kitsas.fi/docs/lisaosat/maksuliikenne/valtakirjat/#nordea)
-	[Holvi]( https://kitsas.fi/docs/lisaosat/maksuliikenne/valtakirjat/#holvi)
-	[Danske Bank]( https://kitsas.fi/docs/lisaosat/maksuliikenne/valtakirjat/#danske-bank)
-	[OmaSP]( https://kitsas.fi/docs/lisaosat/maksuliikenne/valtakirjat/#omasp)
...
* Tiliotteen muodostumistiheyden voi määrittää (päivä / viikko / kuukausi) → Tilioteaineisto noudetaan Kitsaaseen [Holvi -lisäosalla]( https://kitsas.fi/docs/lisaosat/holvi/), eli Holvi -pankkiyhteydellä aktivoidaan vain maksuliikenne
...
Ohje Danske Bankin maksuliikennevaltakirjan täyttöön


* Danske Bankin ws-toimeksiantolomake [lomakepohja](/files/Danske_Bank_WS_toimeksiantolomake.docx)

* Lomake toimitetaan osoitteeseen yrityspalvelut@danskebank.fi

_Toimeksiantolomake ei ole vielä virallinen sopimus, vaan lomakkeen pohjalta Danske muodostaa sopimuksen, jonka he lähettävät asiakkaalle allekirjoitettavaksi_
...
Valtuuttajan ja valtuutettavan tiedot

|**Valtuutuksen saanut tilitoimisto tai muu palvelutalo (valtuutettu)**||
|--|--|
|Yrityksen tai yhteisön nimi|Asiakasyrityksen nimi| 
|Y-tunnus|Asiakasyrityksen y-tunnus|
|Osoitetiedot|Postitusosoite, postinumero ja postitoimipaikka|
|Yhteyshenkilön yhteystiedot|Valtuuttavan yrityksen edustaja|
|Yhteyshenkilön puhelinnumero|Täytä| 
|Yheyshenkilön puhelin|Täytä|
|Tilinumero(t) |Täytä|

|**Valtuutuksen saanut tilitoimisto tai muu palvelutalo (valtuutettu)**||
|--|--|
|Palvelutalo|Talouden Ohjelmistopalvelut Taopa Oy|
|Y-tunnus|3117100-5|
|Osoite|c/o Divest Group Oy, Valimotie 17-19|
|Postinumero|00380|
|Postitoimipaikka|Helsinki|
|Yhteyshenkilön|Kitsas Helpdesk|
|Puhelin|0103976710|
|E-mail|kitsas.helpdesk@taopa.fi|
|WS-sopimusnumero|3T2458|
|WS-Käyttäjänumero|4M4503|

|**Käyttöönotettavat palvelut**||
|--|--|
|Aineiston noudot|Valitaan aina muoto XML / CAMT|
|Maksut|Täppää, jos Kitsaasta on tarkoitus tehdä maksuja|
|Tiliote| Päivittäin / viikoittain / kuukausittain|
|Tiliotteen muoto|XML (CAMT053)|
|Viitteet|Kyllä/Ei, suositeltavaa jos tehdään myyntilaskutusta ja halutaan viitesuorituksien kohdistuvan myyntilaskuihin|
|Viiteluettelon muoto|XML (CAMT054) |
|Viiteluettelon muodostumistiheys| Päivittäin / viikoittain / kuukausittain|
|E-laskujen lähetys/vastaanotto|Kitsas käyttää Maventaa verkkolaskutukseen|

|**Vanhat yhteydet edelliseen palvelutaloon**||
|--|--|
|Lopetuspäivämäärä|PP.KK.VVVV|
|Edellisen palvelutalon nimi|Edellisen aineistonhoitajan tiedot|

|**Allekirjoittajan tiedot**||
|--|--|
|Nimi|Täytä|
|Hetu|Täytä|
|Sähköposti-ilmoitus|Allekirjoittajan sähköpostiosoite|


Täytetty valtakirja lähetetään pankkitilin omistavan yrityksen nimenkirjoitusoikeudelliselle henkilölle Dansken toimesta.  

**Mikäli lopullinen maksatustunnus poikkeaa oletuksesta (0+y-tunnus ilman väliviivaa)** ilmoitathan tästä Kitsaan helpdeskiin.

### OmaSP

Ohje OmaSP:n maksuliikennevaltakirjan täyttöön

* Täytä OmaSP:n sähköinen [maksuliikenneyhteysvaltuutuslomake](https://www.signom.com/omasp/PowerFormFlow.signom?flowId=OMASP_BANK_AUTHORIZATION)
* **Täydennä lomakkeelle** valtuuttavan yrityksen ja aineistonhoitajan (Talouden Ohjelmistopalvelut Taopa Oy) tiedot, sekä tarvittavat maksuliikennepalvelut
* Valtakirjan **allekirjoittajan** tulee olla pankkitilin omistavan yrityksen nimenkirjoitusoikeuden mukainen. 
...
|Y-tunnus|Asiakasyrityksen y-tunnus| 
|Yrityksen tai yhteisön nimi|Asiakasyrityksen nimi| 
|Yhteyshenkilön nimi|Valtuuttavan yrityksen edustaja, esim tämän lomakkeen täyttäjä| 
|Yhteyshenkilön puhelinnumero|Täytä| 
|Tilinumero(t) |Täytä|
|Onko valtuuttava yritys sama kuin aineistonhoitaja?|Ei|
...
|Yrityksen nimi|Talouden Ohjelmistopalvelut Taopa Oy|
|Yhteyshenkilön nimi|Kitsas Helpdesk| 
|Puhelinnumero|0103976710|
|Aineistonhoitajan sähköpostiosoite| kitsas.helpdesk@taopa.fi|
|Aineistosiirtoon käytettävä yhteys|WS-kanava|
|WS-kanavan asiakasnumero|Valitaan alasvetovalikosta _Muu_|
|Mikä?| 07856826|
|Aiemman aineistonhoitajan tiedot|Kyllä/Ei (Jos aiempia käyttöoikeuksia halutaan samalla poistaa, ruksitaan kyllä ja täytetään vanhan aineistonhoitajan nimi + poistopäivä)|

|**Käyttöoikeudet ja palvelut**||
|--|--|
|Eräsiirtotiliotteen nouto|Kyllä, jos tiliote halutaan tulevaksi|
|Aineistomuoto| XML |
|Tiliotteen muodostumistiheys| Päivittäin / Viikoittain / 2krt/kk / 1krt/kk |
|Saapuvat viitemaksut|Kyllä, etenkin jos tehdään myyntilaskutusta ja halutaan viitemaksujen kohdistuvan laskuille|
|Aineistomuoto| XML|
|Viiteluettelon muodostumistiheys| Valitse sopiva |
|Lähtevät maksut (XML)|Kyllä, jos halutaan muodostaa maksuja|
|Maksujen erittely|Eräsiirtotiliotteelle (jos lähtevien maksujen erittely halutaan myös verkkopankin tiliotteelle, valitse _Eräsiirto- ja paperi/verkkotiliotteelle_)|
|Tilinkäyttövaltuutus WS-kanavaan|Kyllä / Ei, Kitsas ei ainakaan _vielä_ tue saldohakua|
|Verkkolaskusopimus|Ei (Kitsaan verkkolaskutuksessa käytetään Maventaa)|
|Päiväys|Päivämäärä, kun valtuutuksen halutaan astumaan voimaan|

Täytetty valtakirja lähetetään pankkitilin omistavan yrityksen nimenkirjoitusoikeudelliselle henkilölle.  
